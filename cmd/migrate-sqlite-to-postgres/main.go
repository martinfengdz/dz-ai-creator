...
func main() {
	...
	if err := core.SeedRBACAndBootstrapAdmin(dst, os.Getenv("ADMIN_USERNAME"), os.Getenv("ADMIN_PASSWORD")); err != nil {
...
func migrate(db *gorm.DB) error {
	if err := db.AutoMigrate(
		...
		&core.UserSession{},
		&core.CreditBalance{},
		&core.CreditTransaction{},
		&core.Package{},
		&core.PurchaseIntent{},
		&core.PurchaseIntentNote{},
		&core.FinanceOrder{},
		&core.FinanceRefund{},
		&core.FinanceInvoice{},
		&core.Work{},
		...
		&core.VideoGenerationRecord{},
		&core.GenerationReferenceAsset{},
	); err != nil {
		return err
	}
...
func copyBusinessData(src, dst *gorm.DB) ([]copiedTable, error) {
	...
	if err := copyOne(copyNamedTable[core.AppSettings](src, dst, "app_settings")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.ModelConfig](src, dst, "model_configs")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.SystemAnnouncement](src, dst, "system_announcements")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.Invite](src, dst, "invites")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.InviteRedemption](src, dst, "invite_redemptions")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.UserRole](src, dst, "user_roles")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.User](src, dst, "users")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.UserSession](src, dst, "user_sessions")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.CreditBalance](src, dst, "credit_balances")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.CreditTransaction](src, dst, "credit_transactions")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.Package](src, dst, "packages")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.PurchaseIntent](src, dst, "purchase_intents")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.PurchaseIntentNote](src, dst, "purchase_intent_notes")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.FinanceOrder](src, dst, "finance_orders")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.FinanceRefund](src, dst, "finance_refunds")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.FinanceInvoice](src, dst, "finance_invoices")); err != nil {
		return nil, err
	}
	if err := copyOne(copyCommerceObjectGuards(src, dst)); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.Work](src, dst, "works")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.ReferenceAsset](src, dst, "reference_assets")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.GenerationRecord](src, dst, "generation_records")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.VideoGenerationRecord](src, dst, "video_generation_records")); err != nil {
		return nil, err
	}
	if err := copyOne(copyNamedTable[core.GenerationReferenceAsset](src, dst, "generation_reference_assets")); err != nil {
		return nil, err
	}
...
func collectCommerceObjectGuardCandidates(src *gorm.DB) (map[string]commerceObjectGuardCandidate, error) {
	...
	if src.Migrator().HasTable("reference_assets") && src.Migrator().HasColumn("reference_assets", "storage_scope") {
		var references []core.ReferenceAsset
